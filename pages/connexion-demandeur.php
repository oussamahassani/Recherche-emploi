<?php
  ...
  if (isset($_POST['connexion']))
  {
    if (!empty($_POST['email']) and !empty($_POST['motPasse']))
    {
      ...
      $requeteDemandeur = $bdd->prepare("SELECT * FROM demandeur WHERE email = ? and mot_passe = ?");
      $requeteDemandeur->execute(array($email, $motPasse));
      $demandeurExist = $requeteDemandeur->rowcount();
      if ($demandeurExist == 1)
      {
        $infosDemandeur = $requeteDemandeur->fetch();
        $_SESSION['id_demandeur'] = $infosDemandeur['id_demandeur'];
        header("Location: espace-demandeur/index.php?id_demandeur=".$_SESSION['id_demandeur']);
      }
      else
...
<head>
  ...
  <title>Connexion demandeur</title>
  <!-- Bootstrap core CSS -->
  <link href="../includes/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <!-- IE10 viewport hack pour Surface/desktop Windows 8 bug -->
  <link href="../incudes/css/ie10-viewport-bug-workaround.css" rel="stylesheet">
          ...
          <div id="navbar" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px;">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="#"><span class="glyphicon glyphicon-user"></span> Demandeur</a>
                  </li>     
                  <li class="divider"></li>
                  <li>
          ...
          <div style="margin-top:100px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
            <div class="panel panel-info" >
              <div class="panel-heading">
                <div class="panel-title text-center">Accèder à l'espace demandeur</div>
              ...
              <div style="padding-top:30px" class="panel-body" >
                ...
                <form id="loginform" class="form-horizontal" role="form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                  ...
                  <div style="margin-bottom: 25px" class="input-group">
                    ...
                    <input type="password" class="form-control" name="motPasse" placeholder="Mot de passe">
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-12 control">
                      ...
                      Vous n'avez pas de compte! 
                        <a href="inscription-demandeur.php">Incrivez-vous</a>
                      </div>
                    </div>
                  </div>   
                </form>
