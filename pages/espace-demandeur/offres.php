    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper" style="padding-top:10px;">
          <div class="row">
            <div class="col-lg-12">
              <h2 class="page-header text-center" id="titre"><i class="fa fa-gift" aria-hidden="true"></i> Offres d'emploi</h2>
          ...
          <div class="row">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                  <ul class="list-group">
                  <?php
                    $reponse = $bdd->query('SELECT * FROM employeur, offre WHERE employeur.id_employeur = offre.id_employeur');
