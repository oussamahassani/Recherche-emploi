    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
          <div class="row">
            <div class="col-lg-12">
              <h2 class="page-header text-center" id="titre"><i class="fa fa-paper-plane" aria-hidden="true"></i> Demandes d'emploi envoyées</h2>
          ...
          <div class="row">
               <div class="col-lg-12">
                  <?php
                    ...
                    {
                        $idDemandeur = intval($_GET['id_demandeur']);
                        $requeteDemandeur = $bdd->query('SELECT * FROM demandeur, postuler, employeur, offre WHERE demandeur.id_demandeur = postuler.id_demandeur and postuler.id_offre = offre.id_offre and offre.id_employeur = employeur.id_employeur');
                          ...
                          if($requeteDemandeur->rowCount() > 0)
                        {
                            ...
                            while ($infosDemandeur = $requeteDemandeur->fetch())
                            {
                              ...
                              echo "<h3 class='list-group-item-heading text-center'>".$infosDemandeur['intitule']."</h3>";
                              echo "<p class='list-group-item-text'>".$infosDemandeur['nom_organisation']."</p>";
                              echo "<p class='list-group-item-text'>".$infosDemandeur['date_postulation']."</p>";
                            echo "</a>";
                            }
                            echo "</div>";
