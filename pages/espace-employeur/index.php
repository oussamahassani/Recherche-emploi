    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
          <div class="row">
            <div class="col-lg-12">
              <h1 class="page-header text-center"><?php echo $nom ?></h1>
          ...
          <div class="col-lg-12">
            ...
            <div class="container">
                ...
                <p>Nous vous souhaitons la bienvenue dans votre espace personnel. Ici, vous pourrez gèrer vos offres d'emploi, consulter des CV en ligne, rechercher un CV suivant des critères que vous aurez vous-même défini et plus encore. </p>
