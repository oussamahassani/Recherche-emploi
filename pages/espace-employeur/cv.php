  ...
  <body>
    <div id="wrapper">
      ...
      <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <div class="row">
            <div class="col-lg-12">
              <h3 class="page-header text-center">CV en ligne</h3>
            ...
            <div class="col-lg-12">
               <div class="panel panel-info">
                <div class="panel-heading">
                  <h3 class="panel-title text-center"><i class="fa fa-list" aria-hidden="true"></i> Cliquez sur un CV pour afficher les détails</h3>
                </div>
                <div class="panel-body">
                  ...
                  <?php
                    ...
                    {
                          echo "<li class='list-group-item'>"."<a href='affichecv.php?id_employeur=".$_SESSION['id_employeur']."&id_demandeur=".$donnees['id_demandeur']."'>".$donnees['prenom']." ".$donnees['nom']." - ".$donnees['adresse'].", ".$donnees['pays']."</a>"."<p>".$donnees['profession']."</p>"."</li>";
                    }
                    $reponse->closeCursor();
                  ?>
                </ul>
